$(function() {
  ...
  words = [
    "Proactive", "legacy", "Team", "Engagement", "Objective",
    "Workflow", "Customer",
    "Q1", "Q2", "Q3", "Q4", "Security",
    "Engineering", "Synergy", "Email", "Priority", "Company",
    "Market", "Sales", "Quota", "Talent", "Circle Back", "Priority",
    // More
    "Reach out", "Company", "Business", "Conference",
    "Limits", "Billing", "Auth", "Integration", "NOC", "Sustaining"
  ],
